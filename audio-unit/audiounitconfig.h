...
/* Bundle Identifier */
#define kAudioUnitBundleIdentifier	pongasoft.vst3.SampleSplitter.audiounit
...
#define kAUPluginName 				pongasoft: SampleSplitter

/* A product name for the audio unit, such as TremoloUnit */
#define kAUPluginDescription 		SampleSplitter
...
#define kAUPluginManufacturer 		Sser

// Definitions for the resource file
#define kAudioUnitName				      "pongasoft: SampleSplitter" // same as kAUPluginName
#define kAudioUnitDescription	      "SampleSplitter" // same as kAUPluginDescription
#define kAudioUnitType				      'aufx' // same as kAUPluginType
#define kAudioUnitComponentSubType	'unkw' // same as kAUPluginSubType
#define kAudioUnitComponentManuf    'Sser' // same as kAUPluginManufacturer
